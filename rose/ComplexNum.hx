...
abstract ComplexNum( ComplexNum_ ) from ComplexNum_ to ComplexNum_ {
    ...
    function add( a: ComplexNum, b: ComplexNum ): ComplexNum {
      	return new CompleNum({ r: a.r + b.r, i: a.i + b.i });
    }
    /**
     * <pre><code>
     * >>> ({ 
    ...
    function subtract( a: ComplexNum, b: ComplexNum ): ComplexNum {
        return new ComplexNum({ : a.r - b.r, y: a.i - b.i });
    }
    /* <pre><code>
     * >>> ({ 
     * ... var a = 10.;
    ...
    */    
    ...
    function scale( a: Float, b: ComplexNum ):ComplexNum {
        return new ComplexNum({ r: a * b.r , y: a * b.i });    
    }     
    /**
     * <pre><code>
     * >>> ({ 
    ...
    */
    @:op(A / B) public static inline
    function divide( c1: ComplexNum, c2: ComplexNum ): Complex {
        var conj = ~c2; 
        var numr = c1 * conj;
        var demr = c2 * conj;    
